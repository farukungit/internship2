...
void main(void) {
    ...
    //while (1) { //sonsuz döngü için for'ları kapat, while aç
        ...
        // x motorun sola, y motorun ileri gittiği kod
        //P1OUT |= DIR1_PIN;     // Motor1 sağa
        //P1OUT &= ~DIR2_PIN;    // Motor2 sola
        //for (i = 0; i < 5; i++) {           // 5 tur dönsün (her biri 40000 adım)
        //dual_pulse(40000, 5);}


        //x motoru sağa, y motoru geri 
        //P1OUT &= ~DIR1_PIN;    // Motor1 sağa
        //P1OUT |= DIR2_PIN;     // Motor2 sola
        //for (i = 0; i < 5; i++) {           // 5 tur dönerler
        //dual_pulse(40000, 5);}


        //x motoru sola, y motoru geri
        //P1OUT |= DIR2_PIN;  // X sola
        //P1OUT |= DIR1_PIN;   // Y sağa
        //for (i = 0; i < 43; i++) {
        //dual_pulse(40000, 5);} // Her iki motora aynı anda pulse gönder
}